...
<ParallaxLayer offset={1} speed={0.45} className="flex justify-center items-center">
  <div className="flex flex-row justify-between">
    ...
    <div className="w-3/5 flex flex-col p-24">
      ...
      <p className="font-montserrat font-normal lg:text-[24px] text-[10px] xt-[10px] text-black">
        We are composed of National University IT students promoting the men&apos;s mental health and gender equality in terms of emotional and lifestyle through the Parallax Website. The researchers came up with the study to be able to recognize promoting social equality for men, creating a more friendly, equitable society and eradicating social stigma and stereotyping against men. Variables that lead to inequality must be identified and addressed. This includes facing the damaging preconceptions and expectations about what it means to be a man, as well as tackling structural prejudices in society.
      </p>
    </div>
  </div>
  <style jsx>{`
...
`}</style>
  ...
  <Carousel loop="true" autoplay="true" className="h-[50vh] lg:h-[70vh]">
...
`}</style>
  ...
  <div className="flex justify-center items-center">
    <button
      type="button"
      className="w-fit flex bg-[#7163DE] text-white py-3 lg:py-5 px-6 lg:px-8 justify-center rounded-full font-montserrat text-sm lg:text-lg font-semibold cursor-pointer mb-4"
...
`}</style>
  ...
  <div className="bg-black bg-opacity-10 rounded-full ml-[5%] w-fit max-h-fit p-8 flex flex-col justify-center items-center">
    <button
      type="button"
      className="w-fit flex bg-[#2E89E4] text-white py-3 px-6 lg:py-5 lg:px-8 justify-center rounded-full font-montserrat text-lg lg:text-xl font-semibold cursor-pointer mb-4"
...
`}</style>
        ...
        <ParallaxLayer offset={4.3} speed={-0.1} factor={1 / 2} className="flex pt-12 justify-center items-center">
        <div className="w-[150px] xl:w-[300px] h-[200px] xl:h-[300px] flex flex-col justify-center items-center bg-[#97C4AC] rounded-lg p-4">
        <div className="w-24 xl:w-40 h-24 xl:h-40 bg-[url('/assets/silva.jpg')] bg-cover bg-center bg-no-repeat rounded-full" />
    <h4 className="font-montserrat font-medium text-xl text-white text-center pt-4">Veronica Silva</h4>
...
`}</style>
        ...
        >
         <div className="w-[150px] xl:w-[300px] h-[200px] xl:h-[300px] flex flex-col justify-center items-center bg-[#97C4AC] rounded-lg p-4">
  <div className="w-24 xl:w-40 h-24 xl:h-40 bg-[url('/assets/vergara.png')] bg-cover bg-center bg-no-repeat rounded-full" />
  <h4 className="font-montserrat font-medium text-lg xl:text-xl text-white text-center pt-2">
    Krishna Vergara
  </h4>
</div>
<div className="w-[150px] xl:w-[300px] h-[200px] xl:h-[300px] flex flex-col justify-center items-center bg-[#97C4AC] rounded-lg p-4">
  <div className="w-24 xl:w-40 h-24 xl:h-40 bg-[url('/assets/devera.png')] bg-cover bg-center bg-no-repeat rounded-full" />
  <h4 className="font-montserrat font-medium text-lg xl:text-xl text-white text-center pt-2">
...
<ParallaxLayer offset={5.1} speed={-0.2} style={{ zIndex: 50, position: "relative" }}>
  <footer className="flex flex-col pb-6 px-6 lg:px-18">
